				...
				<div className="flex flex-col sm:flex-row mt-10">
					...
					<div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0">
						<p className="leading-relaxed text-lg mb-4">
							...
							enjoyed horse riding in the middle of the day, and always tried to
							wake up early enough to catch the rising sun. I spent a lot of
							evenings in the summer by my pony, fishing, and sitting next to my
							favorite friend - a cat. My first kitten was Lucie. She came into
							my life when I was a little girl. Since that moment, I had a dream
							to have house full of cats and kittens. In 2016 I had a chance to
							visit Ernest Hemingway&apos;s house in Key West. I fell in love
							with the harmony of nature, humans, and the way the cats lived in
							his home. This helped me finally realize my dream of living in a
							house full of cats, so I opened a cattery to make sure that every
							single cat would live a life full of love. I specialize in British
							and Scottish chinchillas, they are so kind & super sweet.
						</p>
					</div>
				</div>
			</div>
