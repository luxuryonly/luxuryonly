			...
			{kingList.map(
				({ name, birthday, description, images, breed, color }, index) => (
					...
					>
						...
						>
							<h3 className="title-font sm:text-4xl text-3xl mb-3 font-medium text-gray-900">
								{name}
							</h3>
							<h4 className="title-font sm:text-2xl text-xl my-2 font-medium text-gray-900">
								{breed}
							</h4>
							<p className="title-font sm:text-xl text-lg my-1 font-medium text-gray-900">
								{color}
							</p>
							<p className="title-font sm:text-xl text-lg mb-2 mt-1 font-medium text-gray-900">
								{birthday}
							</p>
