		...
		>
			...
			<div className="md:w-1/2 lg:pl-28 md:pl-16 flex flex-col items-center">
				...
				<p className="my-8 max-w-lg px-5 leading-relaxed">
					...
					well-socialized and lovable kittens, then you are in the right place!
					We truly love cats and put a lot of thought, love, and care in
					breeding our cats.
				</p>
			</div>
		</section>
			...
			<div className="flex flex-col basis-full justify-center md:items-stretch items-center md:flex-wrap md:flex-row">
				<div className="nft-card">
					...
					<div className="p-5">
						...
						<p className="p-4 leading-relaxed">
							...
							affectionate pets are ideal companions for families with children
							and other pets due to their easy going nature, but they can adapt
							to a wide range of environments. The British Shorthair breed is
							much calmer than other cats. You will see your British Shorthair
							play and run for a few minutes, but these cats are calm and
							laidback most of the time. It’s a cat that will surprise you with
							its intelligence, loyalty, and affection.
						</p>
					</div>
				</div>
				<div className="nft-card">
					...
					<div className="p-5">
						...
						<p className="p-4 leading-relaxed">
							The Scottish Fold is a sweet, charming breed. They are an easy cat
							to live with and to care for. They are affectionate and are
							...
							the family. This kitten-like behavior is retained throughout their
							whole lives which makes these enigmatic cats popular with
							families.
						</p>
					</div>
				</div>
				<div className="nft-card">
					...
					<div className="p-5">
						...
						<p className="p-4 leading-relaxed">
							Ragdoll cats are social and happily spend time in the house of the
							owner and rarely wander out on their own. They love being with the
							owner, they yearn for attention and enjoy the company of people.
							They love being embraced by people and often snuggle up in their
							lap. They enjoy following their owners and doing what they are
							doing. Not only do they like people, but they also like other cats
							and other pets, including dogs. In fact, they even like strangers!
						</p>
					</div>
				</div>
			</div>
